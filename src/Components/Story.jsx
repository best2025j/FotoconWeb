...
const Story = () => {
    ...
    <div className=" py-10 px-12 flex justify-around">
        <div className="">
          <img src={Image} alt="/" className="w-[539.58px] h-[521px]"/>
        </div>

         <div className="space-y-10 py-12">
          <h1 className="text-[36px]">Our Story</h1>
          <div>
            <p className="text-xl w-[470.61px] h-[355px]">
